...
- [Win-EnumVsCodeExtension](https://github.com/xephora/Threat-Remediation-Scripts/blob/main/Misc/Win-EnumVsCodeExtension.ps1) - This PowerShell script enumerates installed Visual Studio Code extensions for a specified user account by inspecting the VS Code extensions directories and parsing each extension’s package.json metadata file.
