"""
After reading Cisco Talos's analysis on the 2016 Qakbot anaylsis, I realize their link to download the Qakbot script was no longer accessible and tailored for Python 2.  They provided a screenshot of the code, so I re-coded the script made it Python 3 friendly.
